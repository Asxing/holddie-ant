...
import { getAllMenu, saveMenu } from '@/services/menu';
  ...
  for (let child of item.icons) {
    chidren.push(
      <SelectTreeNode
        ...
        title={
          <span>
            <Icon type={child.icon} style={{ color: '#08c' }} /> &nbsp;&nbsp;{child.title}
          </span>
        }
        key={child.icon}
      />,
        ...
        <Row type="flex" justify="start">
          <Col xs={24} sm={24} md={12} lg={6} xl={6} style={{ backgroundColor: '#fafafa' }}>
            <div style={{ padding: 10 }}>
              <Button icon="plus" type="primary" size="small" onClick={this.addTopMenu}>
                添加顶级菜单
              </Button>
              &nbsp;&nbsp;&nbsp;&nbsp;
              <Button
            ...
            <Tree onSelect={this.onSelect}>{renderMenu(this.state.menuList)}</Tree>
          </Col>
          <Col xs={24} sm={24} md={12} lg={9} xl={9}>
            <Form onSubmit={this.handleSubmit}>
              ...
              <FormItem {...formItemLayout} hasFeedback label="路径">
              ...
              <FormItem {...formItemLayout} hasFeedback label="权限码">
                {getFieldDecorator('authority')(<Input />)}
              </FormItem>
              ...
              <FormItem {...formItemLayout} label="是否隐藏">
                {getFieldDecorator('hideInMenu', { valuePropName: 'checked' })(<Switch />)}
              </FormItem>
